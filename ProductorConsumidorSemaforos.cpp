...
void *funConsumir(void* arg){
    while(true){
        //espero?. restar y comprobar si el numero es negativo o 0, Si lo es espera aque otra hebra haga un signal para desbloquearla.
...
int main(int argc, char** argv) {
    ...
    if(argc != 6){
        ...
        //asignar string a valores booleanos
